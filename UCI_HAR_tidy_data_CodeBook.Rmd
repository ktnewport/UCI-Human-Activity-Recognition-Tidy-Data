...
"Subject_ID" (30)
  Value (numeric)- 1:30
  Represents: 30 individual subject of study
...
"Activity" (6)
  ...
  [6] Walking_Upstairs  
  Represents: the 6 different human activites the     subjects participated in during measurement collection.
...
[21] "tGravityAcc"              
[22] "tGravityAccMag" 
  Represents: the measurements taken or calculated for this dataset to represent detection of human movement.
  
"M_Estimate" (2)
  Value (character) -
  [1] "mean" 
  [2] "std" 
  Represents: whether the value was a calculation of the mean or standard deviation (std).
  
"Average_Measurement" (length = 7020)  
  Value(numeric) - range: -0.9976661 - 0.6446043
  Represents: the averaged measurement value.  The true dependent to the other variables, which were all factors in this dataset.  
